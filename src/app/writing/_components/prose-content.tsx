...
export function ProseContent({ html }: { html: string }) {
  return (
    <div
      className="
        max-w-[700px]
        [&_h1]:font-display [&_h1]:text-3xl [&_h1]:font-extrabold [&_h1]:tracking-[-0.04em] [&_h1]:text-text [&_h1]:mt-12 [&_h1]:mb-4
        [&_h2]:font-display [&_h2]:text-2xl [&_h2]:font-extrabold [&_h2]:tracking-[-0.04em] [&_h2]:text-text [&_h2]:mt-10 [&_h2]:mb-4
        [&_h3]:font-display [&_h3]:text-xl [&_h3]:font-extrabold [&_h3]:tracking-[-0.04em] [&_h3]:text-text [&_h3]:mt-8 [&_h3]:mb-3
        [&_h4]:font-display [&_h4]:text-lg [&_h4]:font-extrabold [&_h4]:tracking-[-0.04em] [&_h4]:text-text [&_h4]:mt-6 [&_h4]:mb-2
        ...
        [&_code]:font-mono [&_code]:text-[13px] [&_code]:bg-border-subtle [&_code]:px-1.5 [&_code]:py-0.5
        [&_pre]:bg-ink [&_pre]:border [&_pre]:border-border [&_pre]:p-5 [&_pre]:overflow-x-auto [&_pre]:my-6
        [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_pre_code]:text-[13px] [&_pre_code]:text-white/80
        [&_img]:border [&_img]:border-border [&_img]:my-6 [&_img]:w-full [&_img]:h-auto
